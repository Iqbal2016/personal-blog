...
//        return $result;
    ...
    public function select_all_portfolio_info(){
     ...
     public function unpublished_portfolio_info($portfolio_id) {
        $this->db->set('portfolio_status', 0);
        $this->db->where('portfolio_id', $portfolio_id);
        $this->db->update('tbl_portfolio');
    }

    public function published_portfolio_info($portfolio_id){
        $this->db->set('portfolio_status', 1);
        $this->db->where('portfolio_id', $portfolio_id);
        $this->db->update('tbl_portfolio');
    }
    public function select_portfolio_info_by_portfolio_id ( $portfolio_id ) {
    	$this->db->select('*');
    	$this->db->from('tbl_portfolio');
    	$this->db->where('portfolio_id', $portfolio_id);
    	$query_result = $this->db->get();
    ...
    public function delete_portfolio_info_by_portfolio_id($portfolio_id){
         $this->db->where('portfolio_id', $portfolio_id);
        $this->db->delete('tbl_portfolio');
    }
    public function select_all_ceritive_info() {
    	$this->db->select('*');
    	$this->db->from('tbl_portfolio');
    	$this->db->where('portfolio_category', 2);
    	$query_result = $this->db->get();
    	$result = $query_result->row();
    	return $result;
    ...
    public function select_all_photography_info() {
    	$this->db->select('*');
    	$this->db->from('tbl_portfolio');
    	$query_result = $this->db->get();
    	$result = $query_result->row();
    ...
    public function select_all_home_page_portfolio_info(){
    	$this->db->select('*');
    	$this->db->from('tbl_portfolio');
    	//$this->db->order_by("portfolio_id","desc");
    	$this->db->order_by("portfolio_id","desc");
