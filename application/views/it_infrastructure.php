        ...
        <div class="blog">
            <div class="row">
                 ...
                 IT service management (ITSM) refers to the entirety of activities directed by policies, organized and structured in processes and supporting procedures
                  that are performed by an organization or part of an organization to plan, deliver, operate and control IT services offered to customers.
                   It is thus concerned with the implementation of quality IT services that meet the needs of customers, and is performed by the IT service
                  provider through an appropriate mix of people, process and information technology.
                 </p> 
                 <p>
                 Differing from more technology-oriented IT management approaches like network management and IT systems management, 
                 IT service management is characterized by
                 </p>
                <p><i class="fa fa-heart"></i> adopting a process approach towards management</p>
				<p><i class="fa fa-heart"></i> focusing on IT services rather than IT systems</p>
				<p><i class="fa fa-heart"></i> stressing continual improvement</p>
